...
module.exports = function (_ref, pluginOptions) {
  ...
  >
    <span
      ...
      style="position: relative; bottom: 0; left: 0; background-image: url('${responsiveSizesResult.base64}'); background-size: cover; display: block;"
    >
      <img
        class="gatsby-resp-image-image"
        data-action="zoom"
        data-original="${originalImg}"
        style="width: 100%; margin: 0; vertical-align: middle; position: relative; top: 0; left: 0; box-shadow: inset 0px 0px 0px 400px ${options.backgroundColor};"
