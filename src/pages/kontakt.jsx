    ...
    <div className="container kontakt-container">
      ...
      <div className={styles.contacts}>
        <Container text>
          ...
          <p>
            Seit über 5 Jahren arbeite ich in den Bereichen Webdesign, Printdesign und Bildbearbeitung. Zusätzlich
            arbeite ich seit über 3 Jahren als Front-End Entwickler. Seitdem konnte ich viele andere talentierte
            Menschen kennenlernen und meine Zeit dafür nutzen, mich kontinuierlich weiterzubilden, Dinge auszuprobieren
            und schlussendlich das Handwerk in meinem Bereich vollends zu erlernen.
          </p>
          <p>
            Für meine Kunden gestalte ich maßgeschneiderte, intuitive und visuell ansprechende Designs und Websiten –
            von der Konzeption über die Kreation bis zur technischen Umsetzung begleite ich alle Schritte.
          </p>
        </Container>
        ...
        <Container>
          <div className={wrapper}>
            <Card link="https://www.discordapp.com" discord>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 272.1" fill="#7289DA">
