...
const Navigation = () => (
  <Headroom calcHeightOnResize disableInlineStyles>
    <div className={styles.logoBrand}>
      <Link to="/">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 493.19 493.19" className={styles.logo}>
          <title>LeKoArts Logo</title>
          <g className={styles.imgLogo} data-name="logo" fill="#fff">
            <g id="Logo_Bildmarke" data-name="Logo Bildmarke">
              <g id="Logo_Bildmarke-2" data-name="Logo Bildmarke">
                <g id="Innen">
        ...
        <span className={styles.logoText}>LekoArts</span>
      </Link>
    </div>
