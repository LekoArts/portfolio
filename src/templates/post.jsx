    ...
    return (
      <div className="container post-container">
        ...
        <Container text>
          ...
          <div className={styles.line} data-help="line" />
          <div className={styles.categoryRef}>
            <p>
              <span>Lust auf mehr?</span> Lese alle Beiträge in der Kategorie <Link to={`/categories/${_.kebabCase(post.category)}`}><Button small blue text={post.category} /></Link>
            </p>
          </div>
  ...
  query BlogPostBySlug($slug: String!) {
    markdownRemark(fields: { slug: { eq: $slug } }) {
      ...
      frontmatter {
        ...
        cover {
          childImageSharp {
            responsiveSizes(maxWidth: 1920, quality: 95, duotone: { highlight: "#EE9338", shadow: "#BE7123" }) {
              base64
              aspectRatio
              src
              srcSet
